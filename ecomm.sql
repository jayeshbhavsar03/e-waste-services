...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 20, 2023 at 03:23 PM
...
(2, 'C.P.U.', 'cpu'),
(3, 'Desktop', 'desktop'),
(4, 'Electrical Components', 'elctrical_components'),
(5, 'EP Box', 'ep_box'),
(6, 'Inverter Battery', 'inverter_battery'),
(7, 'Laptops', 'laptops'),
(8, 'PCB', 'pcb'),
(9, 'Servers', 'servers'),
(10, 'Switches & Routers', 'switches_routers'),
(11, 'Smart Phones', 'smart_phones'),
(12, 'Scanner', 'scanner'),
(13, 'Televisions', 'televisions'),
(14, 'Tablet', 'tablet'),
(15, 'xyz', '');
...
(0, 'jayesh bhavsar', 'bhavsarjayesh9370@gmail.com', '9370821861', 'xyz', 'Dishdudbam');
...
--
-- Dumping data for table `donateus`
--

INSERT INTO `donateus` (`id`, `name`, `email`, `phone`, `service`, `address`, `description`) VALUES
(1, 'jayesh bhavsar', 'bhavsarjayesh9370@gmail.com', '2147483647', 'Donate Your E-Waste', 'Durgawadi road', 'xyz'),
(2, 'harsh', 'h@gmail.com', '1', 'xyz', 'xyz', 'xyz');
...
(1, 'user@user.com', '$2y$10$a7X6bqGq03b5FiTQWRcdcOBQoLkXeRjQ.lVOAJgJBdHu5uCffhChG', 0, 'user', 'user', '', '', '', 1, 'p2NxAvUlKio9', '', '2023-01-16'),
(2, 'admin@admin.com', '$2y$10$SfihSHZpcGFnWDdzJhJbCuJonauI.IR0uxoCRBn9.zuhSp2mV0K8W', 1, 'admin', 'admin', '', '', '', 1, 'YVrdGwy6PlB4', '', '2023-01-16');
